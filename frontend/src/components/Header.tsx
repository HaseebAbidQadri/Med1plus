              ...
              <div className="flex items-center space-x-2.5">
                ...
                <span className="font-semibold text-slate-300 flex items-center space-x-1">
                  ...
                  <span className="text-white font-extrabold flex items-center space-x-1">
                    ...
                    <span> Naveed Akhtar (Administrator)</span>
                  </span>
                </span>
              </div>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-xl md:text-2xl font-black tracking-tight text-[#10b981] leading-none mb-0.5 font-display flex items-center gap-1.5">
                  MedOne<span className="text-[#0d5cb5] font-black">+</span>
                </span>
                <span className="text-[10px] md:text-[11px] font-extrabold tracking-[0.25em] text-[#0d5cb5] uppercase mt-0.5 block leading-none">
                  Pharmacy
                </span>
              </div>
            </div>
                ...
                navItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      id={`nav-item-${item.id}`}
                      className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-extrabold transition-all duration-300 relative ${isActive
            ...
            <div className="space-y-1.5 pb-4">
              ...
              {isAdminLoggedIn && (
                <div className="px-4 py-2 mb-3 bg-emerald-50 rounded-xl text-emerald-800 text-[11px] font-extrabold flex items-center space-x-2">
                  ...
                  <span>Logged in: Naveed Akhtar</span>
                </div>
              )}
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <button
                        key={item.id}
                        onClick={() => handleNavClick(item.id)}
                        className={`w-full text-left px-4 py-3 rounded-xl text-sm font-extrabold transition-all ${isActive
